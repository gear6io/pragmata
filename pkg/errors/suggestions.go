...
// Nouns name the kind of value a suggestion refers to.
const (
	NounFields     = "fields"
	NounKeys       = "keys"
...
// NewSuggestionsOnLevenshteinDistance returns a "did you mean" correction followed
// by the valid-references list. noun names the kind of value (e.g. "fields", "keys").
...
// NewSuggestionsFromFunc formats the string produce returns as a "did you mean: `x`"
// slice, or nil when it returns the empty string.
...
// NewValidReferences formats values as "valid <noun> are `a`, `b`", capped at
// maxValidReferences with a "(+N more)" suffix. Returns "" when no values given.
